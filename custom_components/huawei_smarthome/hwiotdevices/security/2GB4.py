"""Explicit Huawei SmartHome model for the 2GB4 presence sensor."""
...
class HuaweiDevice(HuaweiDeviceStateMixin):
    """Runtime context and protocol mapping for one 2GB4 device."""
    ...
    def __init__(
        ...
        if (descriptor.prod_id or "").strip().upper() != PROD_ID:
            raise ValueError("2GB4 device requires prodId=2GB4")
