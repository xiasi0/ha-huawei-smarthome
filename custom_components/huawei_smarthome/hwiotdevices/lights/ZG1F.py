"""Explicit Huawei SmartHome model for the ZG1F MINI button."""
...
PROD_ID = "ZG1F"
PROFILE_MODEL = "HCP23-BT"
PROFILE_NAME = "华为鸿蒙智家 智能MINI"
MANUFACTURER_NAME = "华为"

SERVICE_SCENE = "scene"
SERVICE_BATTERY = "battery"
STATE_SERVICES = frozenset({SERVICE_SCENE, SERVICE_BATTERY})
...
class WirelessSwitchEvent:
    """One physical key action reported by the ZG1F device."""
...
class HuaweiDevice(HuaweiDeviceStateMixin):
    """Runtime context and protocol mapping for one ZG1F device."""
    ...
    def __init__(
        ...
        if (descriptor.prod_id or "").strip().upper() != PROD_ID:
            raise ValueError("ZG1F device requires prodId=ZG1F")
