"""Explicit Huawei SmartHome model for the ZG0I wireless switch."""
...
PROD_ID = "ZG0I"
PROFILE_MODEL = "OSLO-BS1"
CHANNEL_SERVICE_IDS = ("switch1",)
BUTTON_SERVICE_IDS = ("button1",)
MODE_SERVICE_IDS = ("mode1", "modeX",)
...
class HuaweiDevice(HuaweiDeviceStateMixin):
    """Runtime context and protocol mapping for one ZG0I device."""
